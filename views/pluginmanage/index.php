					...
					<div>
						...
						switch ($status) {
							case PluginManger::STATUS_Enabled:
								?>
								<span><a
										href="<?php echo $this->createUrl('/plugin/pluginManage/disable', array('id' => $plugin['plugin']->identify)); ?>">停用</a></span>
								<span><a
										href="<?php echo $this->createUrl('/plugin/pluginManage/setting', array('id' => $plugin['plugin']->identify)); ?>">设置</a></span>
								<span><a
										href="<?php echo $this->createUrl('/plugin/pluginManage/uninstall', array('id' => $plugin['plugin']->identify)); ?>">卸载</a></span>
								<?php
								break;
							case PluginManger::STATUS_Installed:
								?>
								<span><a
										href="<?php echo $this->createUrl('/plugin/pluginManage/enable', array('id' => $plugin['plugin']->identify)); ?>">启用</a></span>
								<span><a
										href="<?php echo $this->createUrl('/plugin/pluginManage/setting', array('id' => $plugin['plugin']->identify)); ?>">设置</a></span>
								<span><a
										href="<?php echo $this->createUrl('/plugin/pluginManage/uninstall', array('id' => $plugin['plugin']->identify)); ?>">卸载</a></span>
							...
							case PluginManger::STATUS_NotInstalled:
								?>
								<span><a
										href="<?php echo $this->createUrl('/plugin/pluginManage/install', array('id' => $plugin['plugin']->identify)); ?>">安装</a></span>
								<?php
								break;
						}
						?>
